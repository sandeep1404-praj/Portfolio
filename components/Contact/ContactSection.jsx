      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
        ...
        <div className="flex-1">
          ...
          <form className="space-y-8 max-w-2xl" onSubmit={(e) => e.preventDefault()}>
            ...
            <button type="submit" className="relative overflow-hidden px-10 py-4 rounded-full border border-border text-sm font-medium group isolate w-fit">
              <span className="relative z-10 block text-foreground transition-transform duration-300 group-hover:-translate-y-full group-hover:opacity-0 uppercase tracking-widest">
                Submit
              </span>
        ...
        <div className="lg:w-[450px]">
          <div className="bg-card rounded-[40px] p-10 border border-border/60 sticky top-32">
            ...
            <div className="flex items-center gap-6 group/socials">
              ...
              <a href="https://leetcode.com/u/Sandeep-praj-14/" target="_blank" className="text-muted-foreground hover:!text-foreground group-hover/footer-socials:text-muted transition-all duration-300">
