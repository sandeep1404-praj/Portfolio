...
export default function Footer() {
  ...
  return (
    <div className="flex items-center justify-center bg-white font-sans dark:bg-black w-full overflow-hidden">
      <div className="w-full max-w-7xl flex flex-col justify-center py-12 md:py-24 px-4 sm:px-8 lg:px-12">
        <section className="w-full">
          <div className="relative rounded-[2rem] sm:rounded-[3rem] bg-[#E3E3E3] dark:bg-[#111116] p-8 sm:p-16 lg:p-20 flex flex-col items-center justify-center text-center overflow-hidden min-h-[300px] md:min-h-[400px]">
            {/* Background decorative element - only visible on mobile if needed, or hidden if user wants exact previous laptop view */}
            <div className="md:hidden absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-64 h-64 bg-green-500/10 blur-[100px] rounded-full" />
            
            {/* Available for work badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-100 dark:bg-[#2a2a2a] border border-zinc-400 dark:border-zinc-700 mb-8 sm:mb-10">
              <span className="w-2 h-2 rounded-full bg-[#7fef6d] animate-pulse"></span>
              <span className="text-xs sm:text-sm text-zinc-700 dark:text-zinc-300">Available for work</span>
            </div>
