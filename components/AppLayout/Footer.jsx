  ...
  return (<>
    ...
    <footer className="mt-8 w-full pb-8 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-5">
        ...
        <Link href="https://instagram.com" target="_blank" className="text-zinc-500 hover:text-white transition-colors">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Link href="mailto:your@email.com" className="text-zinc-500 hover:text-white transition-colors">
